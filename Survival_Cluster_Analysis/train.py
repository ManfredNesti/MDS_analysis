...
import data.mds.mds_data as mds_data
import importlib
...
if __name__ == '__main__':
    ...
    sleep = {"path": '', "preprocess": sleep_data, "epochs": 300}
    mds = {"path": '', "preprocess": mds_data, "epochs": 400}  # download data from SLEEP website
    all_datasets = {'support': support, 'flchain': flchain, 'seer': seer, 'sleep': sleep, 'mds': mds}
